    ...
    */
    ...
    await queryInterface.bulkInsert('Restaurants',
      [
        ...
        { name: '100 montaditos', description: 'Una forma divertida y variada de disfrutar de la comida. Un lugar para compartir experiencias y dejarse llevar por el momento.', address: 'Av. de la Reina Mercedes, 43, Sevilla', postalCode: '41012', logo: process.env.RESTAURANTS_FOLDER + '/100MontaditosLogo.jpeg', heroImage: process.env.RESTAURANTS_FOLDER + '/100MontaditosHero.jpeg', url: 'http://spain.100montaditos.com/', restaurantCategoryId: 2, shippingCosts: 1.5, email: 'attcliente@gruporestalia.com', phone: '+34902197494', createdAt: new Date(), updatedAt: new Date(), userId: 2, status:'online' },
